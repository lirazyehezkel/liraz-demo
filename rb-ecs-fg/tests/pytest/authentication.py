...
def authenticate(target_key: str, target: TargetService):
    ...
    if target_key == 'TARGET_TRDEMO_CLIENT_TRDEMO':
        pass
    elif target_key == 'TARGET_TRDEMO_CLIENT_TRDEMOHTTP_':
        pass
    elif target_key == 'TARGET_TRDEMO_FLIGHTS_TRDEMO':
        pass
    elif target_key == 'TARGET_TRDEMO_SHOPPINGCART_TRDEMO':
        pass
    elif target_key == 'TARGET_TRDEMO_USERS_TRDEMO':
        pass
    elif target_key == 'TARGET_UNRESOLVED_TARGET':
        pass
    else:
        pass
