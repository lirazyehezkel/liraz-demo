...
### Using Docker
Build docker:
`docker build -t up9-ngm-mar-11-reg-genesis-1 .`

Run tests:
`docker run -it up9-ngm-mar-11-reg-genesis-1:latest`

Run tests with service override:
`docker run -it -e TARGET_CARTS=localhost:55000 up9-ngm-mar-11-reg-genesis-1:latest`
