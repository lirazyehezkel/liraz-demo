...
def authenticate(target_key: str, target: TargetService):
    ...
    if target_key == 'TARGET_ADSERVICE_DEFAULT':
        pass
    elif target_key == 'TARGET_CARTSERVICE_DEFAULT':
        pass
    elif target_key == 'TARGET_CHECKOUTSERVICE_DEFAULT':
        pass
    elif target_key == 'TARGET_CURRENCYSERVICE_DEFAULT':
        pass
    elif target_key == 'TARGET_EMAILSERVICE_DEFAULT':
        pass
    elif target_key == 'TARGET_FRONTEND_DEFAULT':
        pass
    elif target_key == 'TARGET_FRONTEND_DEFAULTHTTP_':
        pass
    elif target_key == 'TARGET_FRONTEND_EXTERNAL_DEFAULT':
        pass
    elif target_key == 'TARGET_FRONTEND_EXTERNAL_DEFAULTHTTP_':
        pass
    elif target_key == 'TARGET_PAYMENTSERVICE_DEFAULT':
        pass
    elif target_key == 'TARGET_PRODUCTCATALOGSERVICE_DEFAULT':
        pass
    elif target_key == 'TARGET_RECOMMENDATIONSERVICE_DEFAULT':
        pass
    elif target_key == 'TARGET_SHIPPINGSERVICE_DEFAULT':
        pass
    else:
        pass
